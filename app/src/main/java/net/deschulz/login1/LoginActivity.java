...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void goToApplication(String msg) {
        Log.i(TAG,"Try to change view: LoggedInActivity");
        //setContentView(R.layout.activity_logged_in);
        Intent intent = new Intent(this,LoggedInActivity.class);
        intent.putExtra(STARTUP_MESSAGE,msg);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private String mLoginStat = "Failed";
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Log.i(TAG,"email + password " + mEmail + " -> " + mPassword);
            try {
            ...
            for (String credential : DUMMY_CREDENTIALS) {
                ...
                if (pieces[0].equals(mEmail)) {
                    ...
                    boolean ret = pieces[1].equals(mPassword);
                    if (ret) {
                        mLoginStat = "Successful login";
                    }
                    return ret;
                }
            }
            ...
            if (mPassword != null && mPassword.isEmpty()) {
                ...
                Log.i(TAG,"Login failed.  Now what?");
                return false;
            }
        }
